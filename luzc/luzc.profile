 ...
 */
function luzc_form_install_configure_form_alter(&$form, $form_state) {
 ...
 */
function luzc_install_tasks() {
  $tasks = array();

  $tasks['luzc_setup_variables'] = array(
    'display_name' => st('Set Variables'),
    'display' => FALSE,
  );

  $tasks['luzc_setup_og_permissions'] = array(
    'display_name' => st('Set Blocks'),
    'display' => FALSE,
  );

  // Run this as the last task!
  $tasks['luzc_setup_rebuild_permissions'] = array(
 ...
 */
function luzc_setup_variables() {
  $variables = array(
    // Features default export path.
    'features_default_export_path' => 'profiles/luzc/modules/custom',
    // Mime-mail.
    'mimemail_format' => 'full_html',
    'mimemail_sitestyle' => FALSE,
    'mimemail_name' => 'Luzc',
    'mimemail_mail' => 'info@luzc.com',
    // jQuery versions.
 ...
 * created.
 */
function luzc_setup_og_permissions() {
 ...
 * installation.
 */
function luzc_setup_rebuild_permissions() {
  node_access_rebuild();
}
